...
public class PnlClientes extends javax.swing.JPanel {
     ...
     */
    public PnlClientes(GestorClientes gestorClientes) {
        initComponents();
    ...
    private void iniciarTabla() {
        ...
        String[] columnas = {"Cédula", "Nombre", "Edad", "Teléfono", "Correo", "Licencia"};
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Licencia de Conducir");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_END;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
    ...
    Cliente c = gestorClientes.buscarCliente(cedula);
    if (c == null) {
    ...
    txtLicencia1.setText(c.getLicenciaConducir());
    ...
    int opcion = JOptionPane.showConfirmDialog(this,
            "¿Seguro que desea eliminar el cliente con cédula " + cedula + "?",
            "Confirmar eliminación", JOptionPane.YES_NO_OPTION);

    if (opcion == JOptionPane.YES_OPTION) {
        try {
            gestorClientes.eliminarCliente(cedula, new ArrayList<>());
            actualizarTabla();
    ...
    private void buscarCliente() {
        ...
        Cliente cliente = gestorClientes.buscarCliente(cedula); // Implementar este método en GestorClientes
        if (cliente == null) {
            javax.swing.JOptionPane.showMessageDialog(this,
        ...
        txtLicencia1.setText(cliente.getLicenciaConducir());
    ...
    private void actualizarCliente() {
        try {
            ...
            gestorClientes.actualizarCliente(cedula, nombre, nacimiento, telefono, correo, licencia);
    ...
    private void crearCliente() {
        try {
            ...
            Cliente nuevoCliente = new Cliente(cedula, nombre, nacimiento, telefono, correo, licencia);
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Cliente creado con éxito");
